...
brew "tldr" #  cheatsheets for console commands | 🔗  https://github.com/tldr-pages/tldr
...
cask "webstorm" # JavaScript IDE | 🔗 https://www.jetbrains.com/webstorm/
cask "visual-studio-code" # VS Code | 🔗 https://code.visualstudio.com/ 
cask "sublime-text" # Sublime Text | 🔗 https://www.sublimetext.com/
